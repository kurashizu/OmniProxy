...
export function PrivilegeBanner() {
  ...
  return (
    <div className="flex items-center gap-2 bg-warning/10 border-b border-warning/30 px-3 py-1 text-[11px] text-warning">
      ...
      <span>Run as administrator for TUN mode</span>
    </div>
  );
}
