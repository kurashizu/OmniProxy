        ...
        <div className="h-full overflow-y-auto">
            ...
            <div className="mt-4 rounded-lg border border-border bg-card p-4 text-sm text-muted">
                ...
                <div className="mt-3 flex items-center justify-between border-t border-border pt-3">
                    ...
                    <button
                        onClick={() => ipc.openLogDir().catch(() => {})}
                        className="rounded border border-border bg-surface px-2 py-1 text-[12px] text-muted hover:text-text hover:border-primary transition-colors"
                    >
                        {t("common.openDir", locale)}
                    </button>
                </div>
            </div>
            ...
            <div className="mt-4 rounded-lg border border-border bg-card p-4 text-sm text-muted">
                <div className="grid grid-cols-[100px_1fr] gap-y-1.5">
                    ...
                    <a
                        ...
                        onClick={() =>
                            openExternalUrl("https://blog.022025.xyz")
                        }
                    >
                    ...
                    <a
                        className="text-primary hover:underline cursor-pointer tabular-nums"
                        onClick={() =>
                            openExternalUrl(
